...
const rolodex_module_1 = require("../language-server/rolodex-module");
const cli_util_1 = require("./cli-util");
const generator_1 = require("./generator");
const generateAction = (fileName, opts) => __awaiter(void 0, void 0, void 0, function* () {
    const services = (0, rolodex_module_1.createRolodexServices)().Rolodex;
...
function default_1() {
    ...
    const fileExtensions = module_1.RolodexLanguageMetaData.fileExtensions.join(', ');
    program
        .command('generate')
