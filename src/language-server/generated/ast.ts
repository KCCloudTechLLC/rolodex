...
export type RolodexAstType = 'Greeting' | 'Model' | 'Person';

export type RolodexAstReference = 'Greeting:person';

export class RolodexAstReflection implements AstReflection {
    ...
    getReferenceType(referenceId: RolodexAstReference): string {
        switch (referenceId) {
...
export const reflection = new RolodexAstReflection();
